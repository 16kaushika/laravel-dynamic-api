              ...
              <ul class="isMobile astro-zu3ccwit" style="--depth: 0">
                ...
                <li class="astro-zu3ccwit" style="--depth: 0">
                  ...
                  <ul class="isMobile astro-zu3ccwit" style="--depth: 1">
                    ...
                    <li class="astro-zu3ccwit" style="--depth: 1">
                      <a href="#understand-url" class="astro-zu3ccwit" style="--depth: 1">
                        <span class="astro-zu3ccwit" style="--depth: 1">Understanding Endpoint</span>
                      </a>
                    </li>
                    <li class="astro-zu3ccwit" style="--depth: 1">
    ...
    <div class="content-panel astro-qhy5epp2">
      <div class="sl-container astro-qhy5epp2">
        <div class="sl-markdown-content">
          ...
          <h3 id="understand-url">Understanding Endpoint</h3>

          <img class="" alt="" src="image/url_explain_purple.png" />
              ...
              <div class="expressive-code">
                ...
                <figure class="frame is-terminal not-content">
                  ...
                  <div >
                    ...
                    onclick="window.open('{{ route('demo') . '?route=add-data' }}', '_blank');">
                    Try It
                  </button>
                </div>
                <div class="copy">
                  <button title="Copy to clipboard" data-copied="Copied!" data-code="curl -X POST {{ env('APP_URL') }}/api/electronic-devices/inventory -H 'Content-Type: application/json' -d '{&quot;device_name&quot;:&quot;Smartphone X200&quot;,&quot;brand&quot;:&quot;TechBrand&quot;,&quot;price&quot;:799,&quot;stock_quantity&quot;:50,&quot;features&quot;:{&quot;screen_size&quot;:&quot;6.5 inches&quot;,&quot;battery&quot;:&quot;4000 mAh&quot;,&quot;processor&quot;:&quot;Octa-core&quot;}}'">
                  </button>
                </div>
        ...
        <section id="tab-panel-238" aria-labelledby="tab-238" role="tabpanel">
          <div class="expressive-code">
            ...
            <figure class="frame is-terminal not-content">
              ...
              window</span></figcaption>
              <pre
              data-language="sh"><code><div class="ec-line"><div class="code"><span style="--0:#82AAFF;--1:#3C63B3">curl</span><span style="--0:#82AAFF;--1:#3C63B3"> -X PUT </span><span style="--0:#ECC48D;--1:#3C63B3">{{ env('APP_URL') }}/api/electronic-devices/inventory/1</span><span style="--0:#D6DEEB;--1:#403F53"> </span><span style="--0:#82AAFF;--1:#3C63B3">-H </span><span style="--0:#82AAFF;--1:#3C63B3">'Content-Type: application/json'</span><span style="--0:#82AAFF;--1:#3C63B3"> </span><span style="--0:#82AAFF;--1:#3C63B3">-d </span><span style="--0:#ECC48D;--1:#3C63B3">'{"device_name":"Smartphone X200 Pro","brand":"TechBrand","price":899,"stock_quantity":30,"features":{"screen_size":"6.7 inches","battery":"4500 mAh","processor":"Octa-core"}}'</span></div></div></code></pre>

              <!-- Add Try It button here -->

              <div >
                <button style="background-color: #3d50f5; color: #ffffff; padding: 10px 20px; font-size: 16px; border: none; border-radius: 5px; cursor: pointer; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); transition: background-color 0.3s ease, transform 0.2s ease; margin-top: 20px; font-weight: 600;"
                onmouseover="this.style.backgroundColor='#3C63B3'; this.style.transform='translateY(-2px)';"
                onmouseout="this.style.backgroundColor='#3d50f5'; this.style.transform='translateY(0px)';"
                onmousedown="this.style.backgroundColor='#3d50f5'; this.style.transform='translateY(1px)';"
                onmouseup="this.style.backgroundColor='#3d50f5'; this.style.transform='translateY(-2px)';"
                onclick="window.open('{{ route('demo') . '?route=update-data' }}', '_blank');">
                Try It
              </button>
            </div>
            <div class="copy">
              <button title="Copy to clipboard" data-copied="Copied!"
              data-code="curl -X PUT {{ env('APP_URL') }}/api/electronic-devices/inventory/1 -H 'Content-Type: application/json' -d '{&quot;device_name&quot;:&quot;Smartphone X200 Pro&quot;,&quot;brand&quot;:&quot;TechBrand&quot;,&quot;price&quot;:899,&quot;stock_quantity&quot;:30,&quot;features&quot;:{&quot;screen_size&quot;:&quot;6.7 inches&quot;,&quot;battery&quot;:&quot;4500 mAh&quot;,&quot;processor&quot;:&quot;Octa-core&quot;}}'">
            </button>
          </div>
        </figure>
      </div>
  ...
  <starlight-tabs data-sync-key="pkg" class="astro-jdrv5pdc">
    ...
    <section id="tab-panel-239" aria-labelledby="tab-239" role="tabpanel">
      <div class="expressive-code">
        ...
        <div class="copy">
          <button title="Copy to clipboard" data-copied="Copied!"
          data-code="curl -X PATCH {{ env('APP_URL') }}/api/electronic-devices/inventory/1 -H 'Content-Type: application/json' -d '{&quot;price&quot;:850,&quot;stock_quantity&quot;:25}'">
        </button>
      </div>
    </figure>
  </div>
  ...
  <section id="tab-panel-240" aria-labelledby="tab-240" role="tabpanel">
    <div class="expressive-code">
      ...
      <figure class="frame is-terminal not-content">
        ...
        window</span></figcaption>
        <pre
        data-language="sh"><code><div class="ec-line"><div class="code"><span style="--0:#82AAFF;--1:#3C63B3">curl</span><span style="--0:#82AAFF;--1:#3C63B3"> -X GET </span><span style="--0:#ECC48D;--1:#3C63B3">{{ env('APP_URL') }}/api/electronic-devices/inventory?limit=10&page=1</span></div></div></code></pre>
        <!-- Add Try It button here -->
        ...
        <div >
          ...
          onmousedown="this.style.backgroundColor='#3d50f5'; this.style.transform='translateY(1px)';"
          onmouseup="this.style.backgroundColor='#3d50f5'; this.style.transform='translateY(-2px)';"
          onclick="window.open('{{ route('demo') }}', '_blank');">
          Try It
        </button>
      </div>
      <div class="copy">
        <button title="Copy to clipboard" data-copied="Copied!"
        data-code="curl -X GET {{ env('APP_URL') }}/api/electronic-devices/inventory?limit=10&page=1">
      </button>
    </div>
  </figure>
</div>
  ...
  <section id="tab-panel-241" aria-labelledby="tab-241" role="tabpanel">
    <div class="expressive-code">
      ...
      <figure class="frame is-terminal not-content">
        ...
        window</span></figcaption>
        <pre
        data-language="sh"><code><div class="ec-line"><div class="code"><span style="--0:#82AAFF;--1:#3C63B3">curl</span><span style="--0:#82AAFF;--1:#3C63B3"> -X GET </span><span style="--0:#ECC48D;--1:#3C63B3">{{ env('APP_URL') }}/api/electronic-devices/inventory/1</span></div></div></code></pre>
        ...
        <div >
          ...
          onmousedown="this.style.backgroundColor='#3d50f5'; this.style.transform='translateY(1px)';"
          onmouseup="this.style.backgroundColor='#3d50f5'; this.style.transform='translateY(-2px)';"
          onclick="window.open('{{ route('demo') . '?route=details-data' }}', '_blank');">
          Try It
        </button>
      </div>
      <div class="copy">
        <button title="Copy to clipboard" data-copied="Copied!"
        data-code="curl -X GET {{ env('APP_URL') }}/api/electronic-devices/inventory/1">
      </button>
    </div>
  </figure>
</div>
  ...
  <section id="tab-panel-242" aria-labelledby="tab-242" role="tabpanel">
    <div class="expressive-code">
      ...
      <figure class="frame is-terminal not-content">
        ...
        window</span></figcaption>
        <pre
        data-language="sh"><code><div class="ec-line"><div class="code"><span style="--0:#82AAFF;--1:#3C63B3">curl</span><span style="--0:#82AAFF;--1:#3C63B3"> -X DELETE </span><span style="--0:#ECC48D;--1:#3C63B3">{{ env('APP_URL') }}/api/electronic-devices/inventory/1</span></div></div></code></pre>
